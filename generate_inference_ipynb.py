 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "import os\n",
    "possible_paths = [\n",
    "    \"/kaggle/working/reverse_calm_bridge.pt\",\n",
    "    \"/kaggle/input/reverse-calm-bridge/reverse_calm_bridge.pt\",\n",
    "    \"/kaggle/input/reverse_calm_bridge.pt\"\n",
    "]\n",
    ...
    "    print(f\"Successfully loaded trained bridge weights from {weights_path}!\")\n",
    "else:\n",
    "    print(\"WARNING: Trained weights not found. Please upload reverse_calm_bridge.pt to your Kaggle session.\")\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    ").to(\"cpu\")\n",
    "\n",
    "# Provide Qwen with a token to kick off generation. If bos_token_id is None, fallback to eos_token_id.\n",
    "bos_id = anchor_tokenizer.bos_token_id if anchor_tokenizer.bos_token_id is not None else anchor_tokenizer.eos_token_id\n",
